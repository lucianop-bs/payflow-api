...
public class ExtratoBuilder {
    ...
    public static String gerarLinhaTransacao(TipoTransacao tipoTransacao, String descricao, BigDecimal valor){
       return String.format("[%s] %s - R$ %.2f",tipoTransacao,descricao,valor);
    }
